...
![Following one thing: Roman silver and gold flowed east toward the workshop, and goods flowed west.](figures/bullion-drain.png){#fig-bullion width=88%}
...
king — the middleman not merely passing the metal along but coining it.^[**Sources:** McLaughlin, *Indian Ocean* (Loc 4323), on the 10:1-versus-12:1 ratio and its pull; Dalrymple (Loc 1634, 1636) and McLaughlin, *Silk Routes* (Loc 2715), on Vima Kadphises's gold coinage on the aureus standard. **Read more:** the India compendium `readings/notes/kindle_compendium/10_india_longrun.md`.]
...
- **Import sources** — India (spices, cottons, gems) above all; Arabia (incense); China (silk, via Parthian and Kushan intermediaries).^[**Sources:** Casson (ed.), *The Periplus Maris Erythraei* (1989), for the cargo lists; McLaughlin (2014); the brief `module_design/02_topic_2.md`.]
:::
...
![Roman shipping to India jumped more than sixfold after the annexation of Egypt (Strabo's report).](figures/shipping-increase.png){#fig-ships width=52%} The infrastructure behind that figure is
...
![The scale of a single cargo: one returning 200-ton pepper ship was worth about six million sesterces.](figures/pepper-cargo.png){#fig-cargo width=70%}
...
![Why the metal moved east: the gold-to-silver arbitrage between Rome and the East.](figures/silver-arbitrage.png){#fig-arbitrage width=76%} It was also the period in which pepper crossed from luxury to
