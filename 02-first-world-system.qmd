...
turned the whole eastern trade into revenue.^[**Sources:** McLaughlin, *Indian Ocean* (Loc 3030, 3337) on Aksum's seizure of Adulis; the brief `module_design/02_topic_2.md`, §1, on Alexandria as the western emporium and customs point. **Read more:** McLaughlin, *The Roman Empire and the Indian Ocean* (2014).]
...
- **Import sources** — Rome (bullion); India and the wider Indian Ocean, whose goods passed through on the way west.^[**Sources:** McLaughlin, *Indian Ocean* (Loc 352, 1657, 3384–3386). **Read more:** the brief `module_design/02_topic_2.md`.]
:::
