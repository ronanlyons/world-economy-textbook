...
![India in the first world system: regions, emporia and the two trade arms (stylised; not to scale).](figures/actor-india-t2.png){#fig-india-t2 width=66%}
...
was the reason no single merchant ever "ran" the Silk Road end to end.^[**Sources:** the brief `module_design/02_topic_2.md`; Dalrymple (Loc 1550) on Kushan control of the Hindu Kush passes.]
:::
...
defines this chapter began in earnest.^[**Source:** McLaughlin, *Indian Ocean* (Loc 4323), on the arbitrage and the drain.] It was also the period in which pepper crossed from luxury to
