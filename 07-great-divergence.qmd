...
turns, so we return to weigh it in the [Conclusion](11-conclusion.qmd).^[**Sources:** the centre-of-gravity ledger, `module_design/centre_of_gravity_ledger.md`, Topic 7 (the pivotal entry); the module synthesis, `module_design/11_synthesis.md`, Q4. **Read more:** Pomeranz, *The Great Divergence* (2000), the book that named the debate.]

![Centre-of-gravity locator (c.1850): the hinge — the weight crosses from Asia to the North Atlantic. Author's schematic.](figures/cog-locator-07.png){#fig-cog07}
...
pivotal, deliberately-unresolved line, adjudicated at the* [Conclusion](11-conclusion.qmd)*.)*^[**Sources:** centre-of-gravity ledger, `module_design/centre_of_gravity_ledger.md`, Topic 7; Broadberry, Custodis & Gupta (2015) and Broadberry, Guan & Li (2018) for the early-divergence case; Pomeranz (2000) and Allen (2009) for the late case. **Read more:** the *Debate* box below.]
