...
::: {.chapter-subtitle}
The turning point of the whole story — and its most open question. That the centre moved is not in doubt; when it moved, and why, is the book's central debate.
:::
...
yet the workshop. This chapter is **the turning point**. By 1850 the centre has moved to the North
...
turns, so we return to weigh it in the [Conclusion](11-conclusion.qmd).^[**Sources:** the centre-of-gravity verdict, `module_design/centre_of_gravity_ledger.md`, Topic 7 (the pivotal entry); the module synthesis, `module_design/11_synthesis.md`, Q4. **Read more:** Pomeranz, *The Great Divergence* (2000), the book that named the debate.]

![Centre-of-gravity locator (c.1870): the turning point — the weight has just crossed from Asia to the North Atlantic. On Maddison's figures Asia was still 43.7 per cent of world output against the North Atlantic's 36.1 in 1850, and the two cross in the middle 1860s; the marker is placed accordingly. Author's schematic, positioned from the shares data.](book/figures/cog-locator-07.png){#fig-cog07}
...
demographic — run earlier. *(Confidence: high on the move; the* why *is the debate — the centre-of-gravity verdict's
pivotal, deliberately-unresolved line, adjudicated at the* [Conclusion](11-conclusion.qmd)*.)*^[**Sources:** centre-of-gravity verdict, `module_design/centre_of_gravity_ledger.md`, Topic 7; Broadberry, Custodis & Gupta (2015) and Broadberry, Guan & Li (2018) for the early-divergence case; Pomeranz (2000) and Allen (2009) for the late case. **Read more:** the *Debate* box below.]
...
its turning point (the move west by 1850 — high confidence; the *why* left open for the
[Conclusion](11-conclusion.qmd)). The **quantity to quality** thread resolves: the divergence *is* the switch from
