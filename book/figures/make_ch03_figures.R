...
text(x, 0.25, "c.1000 - the bipolar Asian/Islamic core; Europe peripheral",
     col = "#333333", font = 3, cex = 0.95, adj = 0.8)
...
text(97, 64, "agrarian-fiscal core;\ncentre shifting south", cex = 0.62, col = grey, font = 3)
points(70, 76, pch = 19, col = accent, cex = 1.1); text(70, 76, "Chang'an", pos = 2, cex = 0.72)
points(96, 48, pch = 19, col = accent, cex = 1.1); text(96, 48, "Guangzhou", pos = 3, cex = 0.72)
# Grand Canal (north-south spine)
segments(72, 74, 88, 54, col = base_blue, lwd = 2, lty = 2)
text(74, 61, "Grand Canal", cex = 0.6, col = base_blue, srt = -51)
# Nanhai trade south
...
text(50, 9, "Tamil south - Pallava, rising Chola", cex = 0.64, col = grey, font = 3)
...
points(82, 30, pch = 19, col = accent, cex = 0.9); text(82, 30, "Basra/Siraf", pos = 2, cex = 0.66)
points(14, 40, pch = 19, col = accent, cex = 0.9); text(14, 40, "Cordoba", pos = 4, cex = 0.66)
# silver north
...
text(130, 37, "sea road\nto India\n& China", cex = 0.68, col = base_blue, pos = 2)
...
ph <- list(
  ...
  c(870, 1000,"5 Politics fragment, sea trade goes on","#cfe0d4"))
...
# one label per dot, staggered: odd events below the axis, even events above
text(541, 1.3, "541 plague", cex = 0.6, col = accent)
text(751, 1.3, "751 Talas", cex = 0.6, col = accent)
text(762, 9.1, "762 Baghdad", cex = 0.6, col = accent)
text(830, 1.3, "830 Belitung", cex = 0.6, col = accent)
text(878, 9.1, "878 Guangzhou massacre", cex = 0.6, col = accent)
...
text(250, 13.1, "coined-bullion band  ~10-14 : 1", col = base_blue, font = 2, cex = 0.82)
# axis
axx <- c(-500, -250, 1, 300, 700, 1000)
labx <- c("500 BCE", "250 BCE", "1 CE", "300 CE", "700 CE", "1000 CE")
segments(-600, 0, 1000, 0, col = grey)
segments(axx, -0.3, axx, 0, col = grey)
text(axx, -1.1, labx, cex = 0.7, col = grey, xpd = TRUE)
...
text(800, 13.1, "Abbasid c.800 (implied)", cex = 0.62, col = accent, font = 2)
...
text(b[1], 1300, "the silver pours north\nwithin one generation", cex = 0.82, col = accent, font = 2)
...
text(41, 14.5, "~55,000 Changsha bowls (mass-produced for export)", col = "white", font = 2, cex = 0.72)
...
text(b[1:3] %*% c(1,1,1)/3, 585, "Asia / the Islamic world", col = base_blue, font = 2, cex = 0.8)
